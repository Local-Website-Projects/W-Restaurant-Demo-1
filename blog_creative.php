...
<head>
    ...
    <title>Blog - DEE LINCOLN PRIME</title>
...
<body class="main header-fixed">
    ...
    <div id="wrapper">
        ...
        <section class="blog-creative">
            <div class="container">
                <div class="row">
                    <div class="col-xl-7 col-md-12">
                        <div class="blog-creative-main">
                            <div class="top">
                                <p class="time">
                                    October 5, 2022
                                </p>
                            ...
                            <div class="main">
                                <a href="#" class="title h3">Food is the foundation of <br /> true happiness </a>

                                <ul class="meta">
                                    <li><a href="#">Written by Johnson Marthon</a></li>
                                    <li><a href="#">2 Comments</a></li>
                                    <li><a href="#">World restaurants, Food</a></li>
                                </ul>

                                <div class="line"></div>
                                <p class="text">As the old saying goes, “A picture is worth 1000 words.” This statement
                                    resonates clearly for people in the restaurant business. What sells your menu items?
                                    Your photos sell them. Professional photography is vital as part of your overall
                    ...
                    <div class="col-xl-5 col-md-12">
                        <div class="blog-creative-list">
                            <div class="blog-creative-box">
                                <div class="image">
                                    <img src="assets/images/section/blog-01.jpg" alt="">
                                </div>
                                <div class="content">
                                    <a href="#" class="title"> How to Design a Small Restaurant </a>
                                </div>
                            </div>
                            <div class="blog-creative-box">
                                <div class="image">
                                ...
                                <div class="content">
                                    <a href="#" class="title"> How Real Restaurants Approach Benefits </a>
                                </div>
                            </div>
                            <div class="blog-creative-box">
                                <div class="image">
