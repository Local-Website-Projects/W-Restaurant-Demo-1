...
<head>
    ...
    <title>About - Basilico Restaurant</title>
...
<body class="main header-fixed p-about counter-scroll">
    ...
    <div id="wrapper">
                        ...
                        <div class="menu-content">
                            <div class="block-text center">
                                ...
                                <p data-aos-duration="1000" data-aos="fade-up">Enjoy a verdant Garden to Glass experience. It’s in the view, it’s reflected in the
                                    ...
                                    for every guest.</p>
                                <a href="menu.php" class="tf-button style3">
                                    book a table
                                </a>
                            </div>
                        ...
                        <div class="event-main">
                            ...
                            <div class="event-content">
                                <div class="block-text center style-2">
                                    <p class="subtitle" data-aos-duration="1000" data-aos="fade-up">private event</p>
                                    <h3 class="title" data-aos-duration="1000" data-aos="fade-up">perfect place <br /> for private events </h3>
                                        ...
                                        <div class="content-tab">
                                            <div class="content-inner">
                                                <div class="container_inner">
                                                    ...
                                                    <a href="#" class="tf-button style1">Get started for your event </a>
                                                </div>
                                            </div>
                                            <div class="content-inner">
                                                <div class="container_inner">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="chef-main">
                            <div class="chef-box">
                                <div class="img" data-aos-duration="1000" data-aos="fade-right">
                            ...
                            <div class="block-text center style-2">
                                ...
                                <p class="subtitle" data-aos-duration="1000" data-aos="fade-up">our chef</p>
                                <h3 class="title" data-aos-duration="1000" data-aos="fade-up">Our culinary philosophy </h3>
                                <p class="text" data-aos-duration="1000" data-aos="fade-up">Simple and balanced. Alexander Petillo brings together flavors and
                                ...
                                <p data-aos-duration="1000" data-aos="fade-up">We see our customers as invited guests to a party, and we are the hosts. It’s our job
                                    ...
                                    better.</p>
                                <a href="#" class="tf-button style3">meet all chef</a>
                            </div>
                            <div class="chef-box">
                                <div class="img" data-aos-duration="1000" data-aos="fade-left">
                        ...
                        <div class="gallery-ig-main">
                            ...
                            <div class="col-img">
                                <div class="top">
                                    ...
                                    <div class="ig-box">
                                        <img src="assets/images/section/ig-3.jpg" alt="">
                                        <div class="content">
                                            <a href="#" class="ig"><i class="fa-brands fa-instagram"></i></a>
                                        </div>
                                    </div>
        ...
        <section class="s-formmail">
            <div class="container">
                <div class="row">
                    <div class="formmail-content">
                        <div class="block-text center style-2">
                            <p class="subtitle" data-aos-duration="1000" data-aos="fade-up">Choose us your meal to be special</p>
                            <h3 class="title" data-aos-duration="1000" data-aos="fade-up">Waiting For You Every Day </h3>
                            <p class="text" data-aos-duration="1000" data-aos="fade-up">If you would like to stay connected and be the first to know about our news,
